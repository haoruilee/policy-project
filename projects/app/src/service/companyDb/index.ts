...
export const fetchCompanyList = async (companyName?: string) => {
  ...
  const res = await fetch('https://companydb_policy.mdjcsdsj.com/search_company_name', {
...
export const createCompay = async (companyData: CompanyItemData) => {
  ...
  const res = await fetch('https://companydb_policy.mdjcsdsj.com/create_company', {
...
export const updateCompany = async (companyData: CompanyItemData) => {
  const body = { ...companyData };
  const res = await fetch('https://companydb_policy.mdjcsdsj.com/company_update', {
    body: JSON.stringify(body),
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
...
export const deleteCompanyRequest = async (companyData: CompanyItemData) => {
  ...
  const res = await fetch('https://companydb_policy.mdjcsdsj.com/delete_company_by_uniq_code', {
    body: JSON.stringify(body),
    method: 'POST',
    headers: {
      'Content-Type': 'application/json'
